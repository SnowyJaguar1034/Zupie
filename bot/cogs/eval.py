...
from discord import ui, Interaction, app_commands, Object  # Needed for Buttons
...
class Eval(commands.Cog):
    ...
    async def evaluate(self, transaction, code):
    ...
    async def eval_slash(self, interaction: Interaction):
...
async def setup(bot):
    await bot.add_cog(Eval(bot), guild=Object(id=default_guild))
